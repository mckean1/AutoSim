    ...
    public static class ChampionCatalog
    {
        ...
        [
            ...
            CreateChampion(
                ...
                8.0,
                1.00,
                [CreateAbilityEffect(CombatEffectType.Damage, 60, TargetMode.EnemyFrontline, TargetScope.One)]),
            CreateChampion(
                "stormcaller",
                "Stormcaller",
                ...
                10.0,
                1.50,
                [CreateAbilityEffect(CombatEffectType.Damage, 35, TargetMode.EnemyAny, TargetScope.All)]),
            CreateChampion(
                "frost-oracle",
                "Frost Oracle",
            ...
            CreateChampion(
                ...
                [
                    CreateAbilityEffect(CombatEffectType.Damage, 25, TargetMode.EnemyAny, TargetScope.All),
                    CreateAbilityEffect(CombatEffectType.Shield, 25, TargetMode.AllyAny, TargetScope.All, StandardShieldDuration)
                ]),
            CreateChampion(
                "lifewarden",
                "Lifewarden",
